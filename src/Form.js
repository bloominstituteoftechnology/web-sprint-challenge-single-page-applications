            ...
            <label> Select Bar
              <select onChange={change}  value={statePizza.choice16} name="choice16">
                 ...
                 <option>Jumbo </option>
                     ...
                     <h3>Must Select One Sauce</h3>
                       <h5> Required</h5>
                       <h6>tomatos</h6>
                       <input onChange={change}  checked={statePizza.choice1}   name = "choice1" type="radio"  value ={statePizza.choice1}  />
                       <h6>Garlic</h6>                     
                       <input onChange={change}  checked={statePizza.choice2}   name = "choice2" type="radio"  value ={statePizza.choice2}   />
                      ...
                      <div className = "toppings"> 
                       <input onChange={change}  checked={statePizza.choice5}  name = "choice5" type="checkbox"  value ={statePizza.choice5} />
                       <h6>tomatos</h6>
                       <input onChange={change}  checked={statePizza.choice6}  name = "choice6" type="checkbox"   value ={statePizza.choice6}/>
                       <h6>cheese</h6>
                       <input onChange={change}  checked={statePizza.choice7}  name = "choice7" type="checkbox"  value ={statePizza.choice7} />
                       <h6>mango</h6>
                       <input onChange={change}  checked={statePizza.choice8}  name = "choice8" type="checkbox"  value ={statePizza.choice8}/> 
                       <h6>orange</h6>
                       <input onChange={change}  checked={statePizza.choice9}  name = "choice9" type="checkbox"  value ={statePizza.choice9} />
                       <h6>chicken</h6>
                       <input onChange={change}  checked={statePizza.choice10}  name = "choice10" type="checkbox"  value ={statePizza.choice10}/>
                       <h6>vampire</h6>
                       <input onChange={change}  checked={statePizza.choice11}  name = "choice11" type="checkbox"  value ={statePizza.choice11}/>
                       <h6>pine</h6>
                       <input onChange={change}  checked={statePizza.choice12}  name = "choice12" type="checkbox"  value ={statePizza.choice12}/>
                       <h6>pepper</h6>
                       <input onChange={change}  checked={statePizza.choice13}  name = "choice13" type="checkbox"  value ={statePizza.choice13}/>
                       <h6>vegi</h6>
                       <input onChange={change}  checked={statePizza.choice14}  name = "choice14" type="checkbox"  value ={statePizza.choice14} />
                       <h6>supreme</h6>
                       <input onChange={change}  checked={statePizza.choice15}  name = "choice15" type="checkbox"  value ={statePizza.choice15}/>
                       <h6>extra cheese</h6>
                       </div>
                         <h3>Choice of Substitue</h3>
                           <h5> Choose up to 1</h5>
                             <h6> Gluten Free Crust(+ $1.00)</h6>
                               <input onChange={change}  checked={statePizza.choice21}  name = "choice21" type="checkbox"  value ={statePizza.choice21}  />  
                                 <h5> Submit name a minimal of 10 characters</h5>
                                   <input onChange={change}  checked={statePizza.choice18}  name = "choice18" type="text" placeholder="First Name"  value ={statePizza.choice18}  />    
                                     <input onChange={change}  checked={statePizza.choice19}  name = "choice19" type="text" placeholder="Last Name"  value ={statePizza.choice19} />    
