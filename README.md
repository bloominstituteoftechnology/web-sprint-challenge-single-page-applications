...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    It is used to provide access to the closest matching route when no arguments are provided. It is commonly used in nested paths.

1. How would you explain form validation to someone who has never programmed before?
    It is a method used to ensure that the proper information is entered into an input area before submitting the information.  It is designed to make the user experience less frustrating.

1. In 1-2 sentences, define end to end testing.

    It involves testing the entire user experience.  Items such as inputs, clicks, dropdowns, checkboxes, etc. are all tested to ensure proper functionality.  It can assist in pointing out which functions are not working as expected.
