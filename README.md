...
React's useRouteMatch is used to get access to the match data even if you render a route outside of a switch.

1. How would you explain form validation to someone who has never programmed before?
Form validation is used to make sure the user doesn't submit invalid data such as a string when there should be a number.

1. In 1-2 sentences, define end to end testing.
End to end testing is a testing method that test a applications workflow for start to finish. It replicates user input to validate for intergration and data integrity.
