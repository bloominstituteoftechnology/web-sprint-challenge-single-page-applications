...
useRouteMatch functions like Route except it is used when you want to display different matches from your url. example: website.com/items/0

1. How would you explain form validation to someone who has never programmed before?
    Form validation is a way of making sure that a user is not entering improper values and also that they did not make any mistakes while entering data. This makes sure that data passed to the database is in the correct 'shape'
1. In 1-2 sentences, define end to end testing.
    End to end testing is a way for people to run tests that simulate ways that a user may interact with your website. Testing ensures that your site will work as expected when the consumer is interacting with it.
