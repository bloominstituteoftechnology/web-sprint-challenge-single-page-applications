...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    This hook allows us to add nested routes to an application. Thus allowing you to change a url with a parameter without having to 
    create the whole code again. 


1. How would you explain form validation to someone who has never programmed before?


Form validations only allows submissions that are accepted by the developer. 
Checks the data and makes sure it is consistent with what is being asked for. 


1. In 1-2 sentences, define end to end testing.

is when you test user navigation of the site.
