...
1. How would you explain form validation to someone who has never programmed before?
	used to occur at the server, after the client had entered all the necessary data and then pressed the Submit button

1. In 1-2 sentences, define end to end testing.refers to a software testing method that involves testing an application's workflow from beginning to end
