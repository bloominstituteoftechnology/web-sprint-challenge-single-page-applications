...
Validation is used to make sure a form is filled out correctly by the user. It makes sure there are no errors so the people reading the submissions doesn't cause any confusion.   
