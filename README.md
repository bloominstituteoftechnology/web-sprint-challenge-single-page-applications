...
Attempts to match the current url the same way <Route> does.

1. How would you explain form validation to someone who has never programmed before?

It is making sure all of the required inputs are filled and the correct values are inputed by the user.

1. In 1-2 sentences, define end to end testing.

End to end testing is going throught the app's workflow making sure everything works the way it's supposed too.
